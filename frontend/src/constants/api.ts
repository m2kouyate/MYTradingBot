...
export const API_ENDPOINTS = {
  ...
  STRATEGIES: {
    ...
    BALANCE_HISTORY: '/api/strategies/balance-history/',
    PNL_HISTORY: '/api/strategies/pnl-history/',
  },
  TRADES: {
    LIST: '/api/trades/',
  ...
  EXCHANGE_KEYS: {
    LIST: '/api/exchange-keys/',
    CREATE: '/api/exchange-keys/',
    UPDATE: (id: number) => `/api/exchange-keys/${id}/`,
    DELETE: (id: number) => `/api/exchange-keys/${id}/`,
    VERIFY: (id: number) => `/api/exchange-keys/${id}/verify/`,
  },
}